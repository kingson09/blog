...
### 20180509
Google I/O大会，“有35%的专业Android开发者在使用Kotlin”，我想说那你的Dart呢，Flutter用dart，Kotlin又是Android 开发一级语言，到底闹哪样，ios那边推swift，冲你们这瞎搞的状态，只能让我感觉Html5才最有可能成为未来三端统一架构的开发语言，只要未来Google和Apple不要给使绊子就行